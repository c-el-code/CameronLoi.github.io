        ...
        <div className="md:col-span-5 flex justify-center md:justify-end order-1 md:order-2">
          <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80 select-none">
            ...
            <motion.div
              ...
              className="absolute -top-12 -right-10 bg-white/95 backdrop-blur-md rounded-2xl p-3 border border-slate-200/60 shadow-lg flex items-center gap-3 max-w-[200px]"
              style={{ x: 10, y: -10 }}
            >
